...
export const useFetchConversationsSummary = () => {
    ...
    const fetchConversationsSummary = async (params?: FetchConversationsSummaryParams) => {
        setLoading(true);
        setError("");
    ...
    return { summary, loadingSummary: loading, errorSummary: error, fetchConversationsSummary };
};