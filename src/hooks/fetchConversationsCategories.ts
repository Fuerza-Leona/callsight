...
export const useFetchConversationsCategories = () => {
    ...
    const fetchConversationsCategories = async (params?: FetchConversationsCategoriesParams) => {
        setLoading(true);
        setError("");
        try {
    ...
    return { conversationsCategories, loadingConversationsCategories: loading, errorConversationsCategories: error, fetchConversationsCategories };
};