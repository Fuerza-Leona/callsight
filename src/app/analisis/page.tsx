...
export default function Home() {
    return (
        <div className="relative left-64 top-32 w-82/100 min-h-screen grid grid-cols-3 gap-2 auto-rows-min m-2">
            <div className="row-span-4 text-white bg- 
            [#1E242B] rounded-md">
            ...
            <Link href={"./buscar"} className="col-span-2 row-span-2 bg-[#1E242B] text-[#FFFFFF] rounded-md flex items-center justify-around">
                <div>
